...
public class Partida {
    ...
    public Partida(Partida objPartida) {
        this.id = objPartida.id;
        this.codigo = objPartida.codigo;
        this.server = objPartida.server;
        this.elecciones = objPartida.elecciones;
        this.jugadoresPorEquipo = objPartida.jugadoresPorEquipo;
        this.inicioPartida = objPartida.inicioPartida;
        this.finPartida = objPartida.finPartida;
        this.duracionPartida = objPartida.duracionPartida;
        this.equipoVencedor = objPartida.equipoVencedor;
    }
